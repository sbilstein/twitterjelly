...
class TweetAdder:
    def __init__(self):
        ...
        self.ids = [i[0] for i in self.sql.q(False,"SELECT id FROM tweets")]
    ...
    def add(self, tweet, created_at_is_obj=False):
        ...
        #checkexists = self.sql.q(False,"SELECT id FROM tweets WHERE id=%s",tweet['id'])
